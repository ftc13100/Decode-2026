...
class redBottomHard: NextFTCOpMode() {
    ...
    private val shootPose = Pose(85.0, 16.0, Math.toRadians(121.0)).mirror()
    ...
    private val PPGtoShot= Pose(85.0, 16.0, Math.toRadians(119.5)).mirror()
    private val PPGtoShotControl= Pose(80.0, 73.26, Math.toRadians(0.0)).mirror()
    //path to pick up PGP motif
    private val pickUpPGP1 = Pose(98.25, 36.0, Math.toRadians(0.0)).mirror()
    private val pickUpPGP2= Pose(135.9, 36.0, Math.toRadians(0.0)).mirror()
    private val PGPtoShot= Pose(85.0, 16.0, Math.toRadians(119.5)).mirror()
    private val PGPtoShotControl= Pose(87.0, 47.6, Math.toRadians(0.0)).mirror()


    private val pickUpPGPcontrol= Pose(81.29, 60.7, Math.toRadians(0.0)).mirror()
    //path to pick up GPP motif
    private val pickUpGPP = Pose(129.7, 28.0, Math.toRadians(0.0)).mirror()
    private val pickUpGPPcontrol= Pose(82.5, 35.3, Math.toRadians(0.0)).mirror()

...
class ShooterController {
    ...
    private val shooterLookupTable: Map<Pair<Double, Double>, ShotParameters> = mapOf(
        ...
        Pair(60.0, 132.0) to ShotParameters(60.0, 132.0, 1100.0, 0.65),
        Pair(72.0, 132.0) to ShotParameters(72.0, 132.0, 1200.0, 0.6),
        Pair(84.0, 132.0) to ShotParameters(84.0, 132.0, 1325.0, 0.6),
        Pair(96.0, 132.0) to ShotParameters(96.0, 132.0,1450.0, 0.6),
        Pair(108.0, 132.0) to ShotParameters(108.0, 132.0, 1525.0, 0.5),
        Pair(120.0, 132.0) to ShotParameters(120.0, 132.0, 1600.0, 0.5),
        Pair(12.0, 120.0) to ShotParameters(12.0, 120.0, 950.0, 0.7),
        Pair(24.0, 120.0) to ShotParameters(24.0, 120.0, 1025.0, 0.7),
        Pair(36.0, 120.0) to ShotParameters(36.0, 120.0, 975.0, 0.65),
        Pair(48.0, 120.0) to ShotParameters(48.0, 120.0, 1075.0, 0.65),
        Pair(60.0, 120.0) to ShotParameters(60.0, 120.0, 1100.0, 0.6),
        Pair(72.0, 120.0) to ShotParameters(72.0, 120.0, 1225.0, 0.6),
        ...
        Pair(120.0, 120.0) to ShotParameters(120.0, 120.0,1550.0, 0.5),
        Pair(132.0, 120.0) to ShotParameters(132.0, 120.0,1550.0, 0.5),
        ...
        Pair(48.0, 96.0) to ShotParameters(48.0, 96.0,1150.0, 0.6),
        Pair(60.0, 96.0) to ShotParameters(60.0, 96.0,1175.0, 0.6),
        Pair(72.0, 96.0) to ShotParameters(72.0, 96.0,1250.0, 0.6),
        Pair(84.0, 96.0) to ShotParameters(84.0, 96.0,1250.0, 0.6),
        Pair(96.0, 96.0) to ShotParameters(96.0, 96.0,1400.0, 0.6),
        ...
        Pair(72.0, 72.0) to ShotParameters(72.0, 72.0,1400.0, 0.5),
        Pair(72.0, 60.0) to ShotParameters(72.0, 60.0,1350.0, 0.5),
        //bottom part starts here
        Pair(72.0, 36.0) to ShotParameters(72.0, 36.0, 1625.0, 0.5),
        Pair(60.0, 24.0) to ShotParameters(60.0, 24.0, 1650.0, 0.5),
        Pair(72.0, 24.0) to ShotParameters(72.0, 24.0, 1650.0, 0.55),
        Pair(84.0, 24.0) to ShotParameters(84.0, 24.0, 1650.0, 0.5),

...
class ShooterController {
    ...
    private val shooterLookupTable: Map<Pair<Double, Double>, ShotParameters> = mapOf(
        ...
        Pair(24.0, 120.0) to ShotParameters(24.0, 120.0, 1000.0, 0.65),
        Pair(36.0, 120.0) to ShotParameters(36.0, 120.0, 1025.0, 0.65),
        Pair(48.0, 120.0) to ShotParameters(48.0, 120.0, 1100.0, 0.6),
        Pair(60.0, 120.0) to ShotParameters(60.0, 120.0, 1175.0, 0.6),
        Pair(72.0, 120.0) to ShotParameters(72.0, 120.0, 1225.0, 0.6),
        Pair(84.0, 120.0) to ShotParameters(84.0, 120.0, 1325.0, 0.55),
        Pair(96.0, 120.0) to ShotParameters(96.0, 120.0,1425.0, 0.5),
        Pair(108.0, 120.0) to ShotParameters(108.0, 120.0,1525.0, 0.5),
        Pair(120.0, 120.0) to ShotParameters(120.0, 120.0,1600.0, 0.5),
        Pair(132.0, 120.0) to ShotParameters(132.0, 120.0,1650.0, 0.5),
        Pair(24.0, 108.0) to ShotParameters(24.0, 108.0,1025.0, 0.65),
        Pair(36.0, 108.0) to ShotParameters(36.0, 108.0,1075.0, 0.6),
        ...
        Pair(120.0, 108.0) to ShotParameters(120.0, 108.0,1500.0, 0.55),
        Pair(36.0, 96.0) to ShotParameters(36.0, 96.0,1100.0, 0.6),
        Pair(48.0, 96.0) to ShotParameters(48.0, 96.0,1125.0, 0.6),
        Pair(60.0, 96.0) to ShotParameters(60.0, 96.0,1150.0, 0.6),
        Pair(72.0, 96.0) to ShotParameters(72.0, 96.0,1300.0, 0.6),
        ...
        Pair(48.0, 84.0) to ShotParameters(48.0, 84.0,1200.0, 0.575),
        ...
        Pair(72.0, 24.0) to ShotParameters(72.0, 24.0, 1650.0, 0.5),
        ...
        Pair(72.0, 12.0) to ShotParameters(72.0, 12.0, 1675.0, 0.5),

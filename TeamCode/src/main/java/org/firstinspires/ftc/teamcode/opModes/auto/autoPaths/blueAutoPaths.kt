...
object blueAutoPaths : Subsystem {
    ...
    //Sequential Groups  == Everything within happens chronologically
     ...
     val pickUpPPG2 = Pose(127.2, 84.0, Math.toRadians(0.0)).mirror()
     val PPGtoShot = Pose(84.0, 84.0, Math.toRadians(0.0)).mirror()
     val pickUpPGP1 = Pose(96.0, 57.0, Math.toRadians(0.0)).mirror()
     val pickUpPGPControl = Pose(84.7, 57.6, Math.toRadians(0.0)).mirror()
     val pickUpPGP2 = Pose(135.8, 57.0, Math.toRadians(0.0)).mirror()
     val PGPtoShot = Pose(84.0, 84.0, Math.toRadians(0.0)).mirror()
     val pickUpGPP1 = Pose(98.25, 36.0, Math.toRadians(0.0)).mirror()
     val pickUpGPP2 = Pose(134.3, 36.0, Math.toRadians(0.0)).mirror()
     val GPPtoShot = Pose(84.0, 84.0, Math.toRadians(0.0)).mirror()
     val gate = Pose(127.5, 75.90674955595027, Math.toRadians(125.0))
     val leavePoint = Pose(87.73, 110.42, Math.toRadians(45.0)).mirror()
     val hitGate = Pose(135.51, 60.203, Math.toRadians(45.0)).mirror()
     val hitGateControl = Pose(90.76, 61.42, Math.toRadians(45.0)).mirror()

...
object blueAutoPaths : Subsystem {
    ...
    val PGP = Pose(9.0, 58.0, Math.toRadians(-174.0))
    val PGPcontrol = Pose(41.17, 61.82)
    val PGPback = Pose(60.0, 84.0, Math.toRadians(-155.0))

    val gate = Pose(11.0, 61.5, Math.toRadians(155.0))
    val eat = Pose(11.0, 60.5,  Math.toRadians(155.0))
    ...
    fun buildPaths() {
        ...
        gateEat= PedroComponent.Companion.follower.pathBuilder()
            ...
            .setLinearHeadingInterpolation(gate.heading, gate.heading)
            .build()

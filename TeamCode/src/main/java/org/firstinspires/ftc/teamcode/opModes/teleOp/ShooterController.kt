...
//Distance      to ShotParameters(Dist,            Velocity,        Angle)                   // Origin (X, Y)
        40.50   to ShotParameters(40.50, 950.0, 0.700),           // Pair(12, 120)
        40.50   to ShotParameters(40.50, 965.0, 0.700),           // Pair(24, 132)
        44.99   to ShotParameters(44.99, 975.0, 0.700),           // Pair(24, 120)
        48.09   to ShotParameters(48.09, 980.0, 0.700),           // Pair(36, 132)
        51.93   to ShotParameters(51.93, 1000.0, 0.600),          // Pair(24, 108)
        51.93   to ShotParameters(51.93, 1000.0, 0.600),           // Pair(36, 120)
        57.20   to ShotParameters(57.20, 1050.0, 0.600),          // Pair(48, 132)
        58.04   to ShotParameters(58.04, 1060.0, 0.600),          // Pair(36, 108)
        60.47   to ShotParameters(60.47, 1100.0, 0.600),          // Pair(48, 120)
        65.79   to ShotParameters(65.79, 1125.0, 0.600),          // Pair(36, 96)
        65.79   to ShotParameters(65.79, 1125.0, 0.600),          // Pair(48, 108)
        67.23   to ShotParameters(67.23, 1140.0, 0.600),          // Pair(60, 132)
        70.03   to ShotParameters(70.03, 1175.0, 0.600),          // Pair(60, 120)
        ...
        104.19  to ShotParameters(104.19, 1400.0, 0.520),         // Pair(72, 72)
        105.11  to ShotParameters(105.11, 1400.0, 0.550),         // Pair(96, 108)
        105.57  to ShotParameters(105.57, 1400.0, 0.525),         // Pair(84, 84)
        109.58  to ShotParameters(109.58, 1400.0, 0.500),         // Pair(96, 96)
        111.32  to ShotParameters(111.32, 1590.0, 0.525),         // Pair(108, 132)
        ...
        115.97  to ShotParameters(115.97, 1460.0, 0.525),         // Pair(108, 108)

...
// does this mean you can just subtract 2 from distance? i don"t think so i can't fully think abt it rn gn
   ...
   //Distance to ShotParameters(Dist,            Velocity,        Angle)            // Origin (X, Y)
        ...
        89.67 to ShotParameters(89.67, 1230.0, 0.520),     // Pair(84,108)
        97.37 to ShotParameters(97.37, 1230.0, 0.510),     // Pair(96, 120)
        98.83 to ShotParameters(98.83, 1200.0, 0.510),     // Pair(72, 72)
        104.50 to ShotParameters(104.50, 1290.0, 0.500),   // Pair(96, 96)
        135.68 to ShotParameters(135.68, 1440.0, 0.500),   // Pair(72, 24)
        136.73 to ShotParameters(136.73, 1460.0, 0.500),   // Pair(48, 12)
        145.90 to ShotParameters(145.90, 1500.0, 0.520),   // Pair(72, 12)
        151.71 to ShotParameters(151.71, 1530.0, 0.500),   // Pair(84, 12)

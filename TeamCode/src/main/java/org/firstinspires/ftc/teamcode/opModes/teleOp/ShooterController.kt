...
object ShooterController {
    ...
    private val shooterLookupTable: Map<Pair<Double, Double>, ShotParameters> = mapOf(
        ...
        Pair(36.0, 96.0) to ShotParameters(36.0, 96.0,1050.0, 0.6),
        ...
        Pair(108.0, 96.0) to ShotParameters(108.0, 96.0,1350.0, 0.6),
        Pair(48.0, 84.0) to ShotParameters(48.0, 84.0,1075.0, 0.6),
        Pair(60.0, 84.0) to ShotParameters(60.0, 84.0,1175.0, 0.575),
        Pair(72.0, 84.0) to ShotParameters(72.0, 84.0,1275.0, 0.55),
        Pair(84.0, 84.0) to ShotParameters(84.0, 84.0,1300.0, 0.525),
        Pair(96.0, 84.0) to ShotParameters(96.0, 84.0,1300.0, 0.5),
        Pair(60.0, 72.0) to ShotParameters(60.0, 72.0,1250.0, 0.5),
        Pair(72.0, 72.0) to ShotParameters(72.0, 72.0,1350.0, 0.5),
        Pair(84.0, 72.0) to ShotParameters(84.0, 72.0,1400.0, 0.5),

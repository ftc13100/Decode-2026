...
object NewTurret : Subsystem {
    ...
    var turretPosition = 0.5
        set(value) {
            ...
            if (::turret1.isInitialized && ::turret2.isInitialized) {
                // Treat both physical servos as one logical turret output.
    ...
    val turretTrackCommand =
        InstantCommand {
            ...
            turretPosition = (targetAngle.rad.wrapped.inDeg / MAX_LIMIT_DEG)
        }
